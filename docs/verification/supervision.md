...
That Cursor delivery proof needed no daemon change once its composer reader was correct; [`runtime-backends.md`](runtime-backends.md#composer) owns the evidence.
