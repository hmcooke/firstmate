...
The durable wake queue preserves actionable events during the residual active-turn window, while [`turnend-guard.md`](turnend-guard.md) owns the lock-owning primary's final Stop recovery decision.
