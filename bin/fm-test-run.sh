...
# Sized from the measured remainder, not from the script count: five shards keep
# a balanced shard near 8 minutes against the 15-minute job cap, where four left
# roughly 3 minutes of worst-case headroom (docs/fm-test-portable-shards.md).
...
family_for_basename() {
  case "$1" in
    ...
    fm-session-lock-service.test.sh|\
    ...
    fm-spawn-launch-prefix.test.sh|\
...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-afk-inject-e2e.test.sh 36012
tests/fm-afk-pi-herdr-return-e2e.test.sh 234
tests/fm-afk-return.test.sh 1803
tests/fm-ask-user-authority.test.sh 264
tests/fm-backend-cmux-smoke.test.sh 53
...
tests/fm-backend.test.sh 18052
tests/fm-backlog-handoff.test.sh 3501
tests/fm-bearings-snapshot.test.sh 50629
tests/fm-bootstrap.test.sh 37860
tests/fm-busy-adapter-wiring.test.sh 15884
tests/fm-busy-state.test.sh 640
tests/fm-calm-pi-extension.test.sh 190
tests/fm-classify-decision-key.test.sh 897
tests/fm-claude-stop-autoarm-live-e2e.test.sh 22
tests/fm-claude-stop-autoarm.test.sh 60732
tests/fm-cmux-claude-composer-live-e2e.test.sh 18
tests/fm-codex-continuity-live-e2e.test.sh 13
tests/fm-composer-matrix-live-e2e.test.sh 23
tests/fm-control-relaunch.test.sh 30609
tests/fm-control.test.sh 37429
tests/fm-cursor-harness.test.sh 30061
tests/fm-cursor-primary-live-e2e.test.sh 21
tests/fm-cursor-primary.test.sh 48628
tests/fm-daemon.test.sh 26739
tests/fm-documentation-audiences.test.sh 1322
tests/fm-fleet-snapshot-view.test.sh 7714
tests/fm-fleet-sync.test.sh 19766
tests/fm-gate-refuse.test.sh 7467
tests/fm-gitignore-config.test.sh 33
tests/fm-gotmp.test.sh 1635
tests/fm-grok-continuity-live-e2e.test.sh 36
tests/fm-grok-stop-live-e2e.test.sh 15
tests/fm-guard-stale-banner.test.sh 6502
tests/fm-harness-liveness-drift-live-e2e.test.sh 13
tests/fm-herdr-session-cleanup.test.sh 6700
...
tests/fm-letterbox-grammar.test.sh 415
tests/fm-letterbox.test.sh 8839
tests/fm-lint-workflows.test.sh 807
tests/fm-muse-harness.test.sh 25369
tests/fm-muse-signals-live-e2e.test.sh 18
tests/fm-on.test.sh 8612
tests/fm-opencode-primary-live-e2e.test.sh 16
tests/fm-operational-input.test.sh 226
tests/fm-peek-remote.test.sh 938
tests/fm-pending-reply.test.sh 14524
tests/fm-pi-primary-live-e2e.test.sh 22
tests/fm-pi-watch-extension.test.sh 15966
tests/fm-pr-check-security.test.sh 226928
tests/fm-procevent-when.test.sh 13284
tests/fm-procevent.test.sh 50174
tests/fm-project-origin.test.sh 137
tests/fm-public-followup.test.sh 40146
tests/fm-quota-array-dispatch-live-e2e.test.sh 13
tests/fm-remote-backlog-handoff.test.sh 20388
tests/fm-remote-doctor.test.sh 4735
tests/fm-remote-entrypoint.test.sh 74
tests/fm-remote-job-orphan-reap.test.sh 2917
tests/fm-remote-job.test.sh 48611
tests/fm-remote-reply.test.sh 29888
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 135649
tests/fm-remote-secondmate-parent-binding.test.sh 11684
tests/fm-remote-secondmate-trace-context.test.sh 40378
tests/fm-secondmate-harness.test.sh 117287
tests/fm-secondmate-lifecycle-e2e.test.sh 11132
tests/fm-secondmate-liveness.test.sh 31165
tests/fm-secondmate-safety.test.sh 37737
tests/fm-secondmate-sync.test.sh 15108
tests/fm-send-remote-delivery.test.sh 4263
tests/fm-send-resolve-key.test.sh 8449
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 159
tests/fm-send-secondmate-marker.test.sh 3688
tests/fm-session-lock-ancestry.test.sh 1019
tests/fm-session-lock-service.test.sh 2709
tests/fm-session-start.test.sh 115305
tests/fm-sessionstart-hook-live-e2e.test.sh 19
tests/fm-sessionstart-instruction-refresh-live-e2e.test.sh 41
tests/fm-sessionstart-nudge.test.sh 24005
tests/fm-shared-captain-inheritance.test.sh 5729
tests/fm-spawn-dispatch-profile.test.sh 59077
tests/fm-spawn-launch-prefix.test.sh 40131
tests/fm-spawn-no-project-instructions.test.sh 23791
tests/fm-spawn-pool-base-freshen.test.sh 13569
tests/fm-spawn-worktree-settle.test.sh 4715
tests/fm-startup-memory-budget.test.sh 12162
tests/fm-startup-network.test.sh 49104
tests/fm-stow-cascade.test.sh 2826
tests/fm-subagent-pretool-check.test.sh 873
tests/fm-supervision-events.test.sh 578
tests/fm-tangle-guard.test.sh 7900
tests/fm-task-delivery.test.sh 1849
tests/fm-teardown-endpoint-safety.test.sh 3645
tests/fm-teardown.test.sh 89818
tests/fm-test-fixture-cleanup.test.sh 557
tests/fm-test-isolation-proof.test.sh 383
tests/fm-tmux-agent-liveness.test.sh 3214
tests/fm-trace-context-lib.test.sh 141
tests/fm-trace-context-spawn.test.sh 34132
tests/fm-turnend-guard.test.sh 33383
tests/fm-update.test.sh 3219
tests/fm-vendor-auth-probe.test.sh 43350
tests/fm-wake-daemon-lifecycle-e2e.test.sh 5712
tests/fm-wake-drain-open-decisions-cursor.test.sh 18623
tests/fm-wake-drain-open-decisions.test.sh 10926
tests/fm-wake-drain-unread-status.test.sh 10932
tests/fm-wake-queue.test.sh 29027
tests/fm-watch-arm.test.sh 58257
tests/fm-watch-checkpoint.test.sh 4918
tests/fm-watch-triage.test.sh 151693
tests/fm-watcher-lock.test.sh 79343
EOF
}
