...
For herdr, [`docs/herdr-backend.md`](../../../docs/herdr-backend.md#native-agent-state-submit-confirmation) owns the confirmation signals, narrow composer exclusions, and active limits.
...
- **Verified type-once submit model** - the digest is typed once (`send-keys -l`
  ...
  For herdr, [`docs/herdr-backend.md`](../../../docs/herdr-backend.md#native-agent-state-submit-confirmation) owns the confirmation signals and fallback limits.
